            ...
            <div className="space-y-3">
              ...
              <fieldset className="border-t border-border pt-3" disabled={!autoLoop}>
                ...
                <p className="mt-2 text-[11px] text-muted-foreground leading-snug">
                  Three caps; the loop terminates when ANY fires. Note: the cost cap is cumulative
                  and checked between iterations — a single iteration's tool calls can run past it
                  before the next check, so actual spend may exceed the cap. Defense-in-depth
                  against runaway loops, not a hard per-iteration ceiling.
                </p>
              </fieldset>
