/**
 * Collapsed inline tool-call card. Native `<details>` for accessibility —
 * no custom toggle JS. Renders inside an assistant `<Message>`.
 */
      ...
      <div className="px-3 py-2 text-xs space-y-2 border-t border-border/70">
        ...
        {call.result_preview && (
          <div>
            ...
            <pre className="font-mono bg-muted rounded px-2 py-1 whitespace-pre-wrap break-words max-h-48 overflow-y-auto">
              {call.result_preview}
            </pre>
          </div>
        )}
